...
type MockClient struct {
	MockGet(projectID string, getOpts *packngo.GetOptions) (*packngo.Project, *packngo.Response, error)
	MockCreate(*packngo.ProjectCreateRequest) (*packngo.Project, *packngo.Response, error)
	MockUpdate(projectID string, *packngo.ProjectUpdateRequest) (*packngo.Project, *packngo.Response, error)
	MockDelete(projectID string) (*packngo.Response, error)
...
func (c *MockClient) Create(createRequest *packngo.ProjectCreateRequest, projectID string) (*packngo.Project, *packngo.Response, error) {
...
func (c *MockClient) Get(requestID string, options *packngo.GetOptions) (*packngo.Project, *packngo.Response, error) {
